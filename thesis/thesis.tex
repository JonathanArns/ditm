...
nicht modifiziert werden können \cite{debugging_distributed_systems_2016}. Es werden so viele Logs wie möglich aus den
...
\section{Debugging}
\subsection{Klassisches Debugging}
\cite{oddity_graphical_debugger}
\cite{gotcha_interactive_debugger}
\subsection{Record and Replay Debugging}
\cite{distributed_replay_debugging_1997} % Ada95, record system, replay single node, first distributed rr
\cite{distributed_replay_debugging_2006} % liblog, only c++
