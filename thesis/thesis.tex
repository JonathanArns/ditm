...
konzentrieren, Abläufe und Zustände im System zu visualisieren. 
...
\begin{figure}[H]
    ...
    \caption{Time-Space Diagramm in Shiviz \cite{ShiViz_visual_debugger}}
	\label{fig:debugAR}
\end{figure}
...
\cite{debugAR_AR_debugger}
\cite{ShiViz_visual_debugger}
