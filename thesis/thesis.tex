...
Eine Netzwerk-Unterbrechung ein einem verteilten System ist eine Situation, in der ein Teil des Netzwerks ausfällt, so dass Teile
...
Shopify entwickelte Toxiproxy\footnote{\url{https://github.com/Shopify/toxiproxy}} ist ein für das Failure-Testing von verteilten
Systemen entwickelter TCP-Proxy, welcher Netzwerk-Unterbrechungen und andere Netzwerk-Fehler simulieren kann.
...
Ebenfalls im Bezug auf allemeiner verwendbares Tooling stellen Basiri et. al. \cite{chaos_engineering} die Frage, ob sich
allgemeiner verwendbares Tooling für Chaos-Engineering entwickeln lässt, da auch hier Organisationen ursprünglich vorwiegend
eigene, interne Tools entwickelt haben.
...
\chapter{Ein Proxy zum Debugging von Netzwerk-Unterbrechungen}
\label{chap:system}
