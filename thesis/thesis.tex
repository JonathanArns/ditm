...
Dazu werden in einem Cluster mit nur zwei Knoten von einem Knoten in kurzer Zeit eine große Menge an
Requests in semi-zufälliger Reihenfolge an den anderen geschickt. Jeder Request ist eindeutig
identifizierbar anhand eines einzigartigen Query Parameters aus zwei Zahlen, die in der
Kombination jeweils nur einmal vorkommen.
