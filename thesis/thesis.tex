...
\begin{abstract}
	% Problem
    Verteilte Systeme sind durch Netzwerk-Unterbrechungen schwierig zu debuggen.
	% Idea
    Diese Arbeit stellt einen proxy-basierten Replay-Mechanismus für die Reproduktion von Partitionstoleranz-Bugs in verteilten
    Systemen vor.
	% Benefit
    Dieser ermöglicht es, Netzwerk-Unterbrechungen in einem verteilten System zu erzeugen, aufzuzeichnen und die Aufzeichnung in
    einem Replay am laufenden System abzuspielen.
	% Approach
    Der Ansatz ist anhand eines Prototypen evaluiert worden. Aus einer Reihe unterschiedlicher Partitionstoleranz-Bugs ist der
    Prototyp in der Lage, alle deterministisch zu reproduzieren.
\end{abstract}
...
Systems. Beispielsweise kann ein einzelner Knoten in einem System abstürzen oder das Netzwerk zwischenzeitig ausfallen. Um die
Verfügbarkeit und Korrektheit von Systemen zu garantieren, ist es wichtig, verteilte Systeme zu entwickeln, die sich von Fehlern
in einzelnen Komponenten selbstständig erholen und weiter funktionieren können. \cite{distributed_systems_book}
...
\begin{figure}[H]
	...
	\caption{Visualisierung eines Stale Reads als Leseoperation in einer verzweigten Transaktions-Historie.
...
\begin{figure}[H]
	...
	\caption{Visualisierung eines Dirty Reads als Leseoperation in einer verzweigten Transaktions-Historie.
...
\begin{figure}[H]
	...
	\caption{Visualisierung einer nicht vollständigen Netzwerk-Unterbrechung (rot), die in MongoDB eine Election-Endlosschleife auslösen konnte}
